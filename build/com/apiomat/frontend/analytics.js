...
* @property {string} url - your Countly server url, you can use your server URL or IP here
...
* @property {boolean} [ignore_bots=true] - option to ignore traffic from bots
...
* @property {number} [inactivity_time=20] - after how many minutes user should be counted as inactive, if he did not perform any actions, as mouse move, scroll or keypress
...
* @property {array=} ignore_referrers - array with referrers to ignore
* @property {boolean} [ignore_prefetch=true] - ignore prefetching and pre rendering from counting as real website visits
